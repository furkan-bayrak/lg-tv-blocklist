...
Pick a tier above, then load the matching file into your blocker. Step-by-step walkthrough per blocker, with checks and uninstall steps: **[docs/install.md](docs/install.md)**.
